<?php 
	...
	require "libs/functions.php";
		if (isset($_POST['group'])){
			$list = $_POST['list']; // Принимаем массив данных с всех checkbox и заносим в переменную
			client_group($list);
		}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Личный кабинет менеджера - Заказы - ОАО "Осколнефтеснаб"</title>
		...
		<div class="row" >
		  <div class="col-md-9">
			<div class="panel panel-default">
			  <div class="panel-body">
					<?php 
						$ord = get_orders_manager_new();
					?>
					<div class="page-header">
						<h3>Новые заказы (<?= count($ord) ?>):</h3>
					</div>
					<form action="manager.php" name="select_all" method="post">
						<table>
							<tr>
							    <td><input type = 'submit' class="btn btn-success" name = 'group' value = 'Перейти к обработке заказов' />&nbsp;</td>
							</tr>
						</table>
						<br>
		  ...
		  <div class="col-md-3">
			<div class="panel panel-default">
				  ...
				  <a href="manager.php" class="list-group-item active">Новые заказы</a>
